...
namespace _6_FlowControl
{
    public class Program
    {
        ...
        {
            GiveActivityAdvice(GetValidTemperature());
            Console.WriteLine();
        ...
        public static int GetValidTemperature()
        {
            ...
            do
            {
                Console.WriteLine("Insert a temperature in F between -40 and 135.");
                action = Console.ReadLine();
            } while (!int.TryParse(action, out temp) && temp < -40 && temp > 135);
            return temp;
        }
        ...
        public static void Register()
        {
            ...
            Console.WriteLine("Time to register a username!");
            username = Console.ReadLine();

            Console.WriteLine("Now make a password.");
